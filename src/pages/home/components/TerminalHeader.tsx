...
export function TerminalHeader({ isDarkMode, toggleTheme }: TerminalHeaderProps) {
            ...
            <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 dark:bg-[#1e1e1e]/90 backdrop-blur-sm border-b border-[#007acc]/20 dark:border-[#39FF14]/20">
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="ml-4 text-sm text-[#007acc] dark:text-[#39FF14]">BeautyKim@portfolio:~$</span>
                    </div>
                    ...
                    >
                        <i className={`${isDarkMode ? 'ri-sun-line' : 'ri-moon-line'} w-4 h-4 flex items-center justify-center`}></i>
